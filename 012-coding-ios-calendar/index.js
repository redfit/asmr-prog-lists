...
class Calendar extends React.Component {
  ...
  render() {
    ...
    return React.createElement(
      ...
      React.createElement(WeekdayTitle, null),
      React.createElement(
        "div",
        {
          className: "dayCellsViewPort",
          onTouchStart: (e) => this.handleSwipeEvent(e, "start"),
          onTouchMove: (e) => this.handleSwipeEvent(e, "move"),
          onTouchEnd: (e) => this.handleSwipeEvent(e, "end"),
        },
        React.createElement(
          "div",
          { className: "dayCellsWrap" },
          React.createElement(
            ...
            React.createElement(DayCells, {
              key: `${month}${year}`,
              month: month,
              year: year,
              dayIsClicked: dayIsClicked,
              onDayClicked: this.handleDayClicked,
            }),
          ),
        ),
      ),
      React.createElement(MonthControls, {
        dir: "left",
        onArrowClick: this.handleMonthChange,
      }),
      React.createElement(MonthControls, {
        dir: "right",
        onArrowClick: this.handleMonthChange,
